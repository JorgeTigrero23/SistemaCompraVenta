            ...
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> Clientes
                        <button type="button" @click="openModal('client','new')" class="btn btn-secondary">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" v-model="search" @keyup.enter="getClients(1,search,criteria)" class="form-control" placeholder="Texto a buscar">
                                <button type="submit"  @click="getClients(1,search,criteria)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            <tr v-for="client in arrayClients" :key="client.id">
                                ...
                                <td v-text="client.document_type"></td>
                                <td v-text="client.document_number"></td>
...
<script>
    ...
    export default {
        ...
        methods: {    
            getClients(page, search, criteria){
                 let me = this;
                 let url = '/cliente?page=' + page + '&search='+ search + '&criteria=' + criteria;
            ...
            changePage(page, search, criteria) {
                ...
                me.getClients(page, search, criteria);
        ...
        mounted() {
            this.getClients(1,this.search,this.criteria);
        }
